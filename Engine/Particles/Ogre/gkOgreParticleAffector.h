...
#ifndef _gkOgreParticleAffector_h_
#define _gkOgreParticleAffector_h_
...
class gkOgreParticleAffector : public Ogre::ParticleAffector
{
protected:
...
public:
	...
	gkOgreParticleAffector(Ogre::ParticleSystem* psys);
	virtual ~gkOgreParticleAffector();
...
class gkOgreAffectorFactory : public Ogre::ParticleAffectorFactory
{
public:
	GK_INLINE Ogre::String getName() const { return gkOgreParticleAffector::NAME; }

	Ogre::ParticleAffector* createAffector(Ogre::ParticleSystem* psys);
};

#endif//_gkOgreParticleAffector_h_
