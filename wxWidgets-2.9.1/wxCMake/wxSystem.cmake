...
set(wxSTC_INC	${wxROOT_SRC}/stc/scintilla/include ${wxROOT_SRC}/stc/scintilla/src)
...
macro(ignore_precompiled_header_wx SRC_FILE)
	if (MSVC)
		set_source_files_properties(${SRC_FILE} PROPERTIES COMPILE_FLAGS /Y-)
	endif()
endmacro(ignore_precompiled_header_wx)
...
macro(SETUP_WX_ALL TARGET)
	...
	#STC defines
	add_definitions(-D__WX__ -DSCI_LEXER -DLINK_LEXERS)
